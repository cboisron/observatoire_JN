(function () {
  ...
  const dictionaries = {
    fr: {
      ...
      "form.unavailable": "<strong>Enregistrement indisponible.</strong> Le service Docker de la VM ne répond pas ; contactez la personne chargée de la maintenance.",
    ...
    en: {
      ...
      "form.unavailable": "<strong>Recording unavailable.</strong> The VM's Docker service is not responding; contact the application maintainer.",
